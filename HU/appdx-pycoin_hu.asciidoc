...
((("key utility (ku)", id="ix_appdx-pycoin-asciidoc0", range="startofrange")))A +ku+ ("key utility") parancssori segédprogram a kulcs kezelés "svájci bicskája". Támogatja a BIP32 kulcsokat, a WIF-et, és a bitcoin vagy altcoin címeket. Az alábbiakban néhány példa szerepel.
...
Annak az ellenőrzése, hogy mindez működik, ha egy BIP32 stringet választunk (ami a 0/3 alkulcsnak felel me):
...
Nyilvános kulcspárból (a Testnet-en):
...
((("transaction utility (tx)")))A +tx+ parancssori segédprogram olvasható formátumban jelentíti meg a tranzakciókat, letölti őket a pycoin cache-éből vagy web szervizekről (jelenleg a blockchain.info, a blockr.io, és a biteasy.com van támogatva), összefésüli őket, bemenetek és kimenetek hozzáadását vagy törlését teszi lehetővé, és tranzakciók aláírására képes.
