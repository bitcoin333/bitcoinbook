...
[Tipp]
====
A bitcoinban nincsenek számlák ill. egyenlegek, csak _el nem költött tranzakció kimenetek_ (UTXO-k) vannak, melyek szét vannak szórva a blokkláncban.
====
...
[Tipp]
====
A bitcoin tranzakció ellenőrzés nem egy statikus módszeren alapul, hanem egy script nyelv végrehajtásán. Ez a nyelv szinte végtelen számú feltétel kifejezését teszi lehetővé. A bitcoin ezáltal lesz „programozható pénz”.
====
