...
Geometrialiga ez a harmidik pont, a P~3 úgy számítható ki, hogy húzunk egy egyeneset a P~1 és P~2 között. Ez az egyenes az elliptikus görbét pontosan egy további helyen fogja metszeni. Nevezzük ezt a pontot P~3'-nek: P~3' = (x, y). A P~3 pont ennek a pontnak az x tengelyre történő tükrözésével kapható meg: P~3 = (x, -y).
